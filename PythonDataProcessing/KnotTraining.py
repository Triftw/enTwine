...
feature = feature.reshape(560,2000)
...
model = kr.Sequential()
model.add(LSTM(units = 100, return_sequences=True,input_shape=(feature_length,4)))
...
model.fit(feature, label ,epochs = epoch, batch_size = batch)
